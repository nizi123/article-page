...
export default function AboutContent() {
  ...
  <div className="border-t border-neutral-200 first:border-t-0">
    <div className="py-12 md:py-16 grid grid-cols-1 md:grid-cols-12 md:gap-x-16 lg:gap-x-24">
      <h3 className="md:col-span-4 text-[22px] md:text-[22px] font-semibold leading-[1.25] tracking-tight text-neutral-800">
        인디음악과 산업에 대한 깊은 탐구
      </h3>
      <p className="md:col-span-7 mt-4 md:mt-0 text-[16px] md:text-[16px] leading-[1.9] text-neutral-600">
